...
protected:
	...
	int main(const std::vector<std::string>& args)
	{
		...
		else
		{
			...
			TimeRequestHandlerFactory* pTimeRequestHandlerFactory = new TimeRequestHandlerFactory;
			HTTPServerParams* pHTTPServerParams = new HTTPServerParams;
			HTTPServer srv(pTimeRequestHandlerFactory, svs, pHTTPServerParams);
